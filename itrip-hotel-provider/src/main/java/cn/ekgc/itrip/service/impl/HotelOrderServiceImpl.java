...
public class HotelOrderServiceImpl implements HotelOrderService {
	...
	/**
	 * <b>查找未支付订货单的订单联系人的Id集合</b>
	 * @return
	 * @throws Exception
	 */
	public List findLinkUserIdsListByOrderStatus(String userCode) throws Exception {
		Map<String, Object> queryMap = new HashMap<>();
		queryMap.put("orderStatus",3);
		queryMap.put("checkOutDate",new Date());
		queryMap.put("userCode",userCode);
		return hotelOrderDao.findLinkUserIdsListByOrderStatus(queryMap);
	}
}
