...
public class HotelOrderTransportImpl implements HotelOrderTransport {
	...
	@RequestMapping(value = "/getlinkuseridslistbyorderstatus",method = RequestMethod.POST)
	public List getLinkUserIdsListByOrderStatus(@RequestParam String userCode) throws Exception {
		return hotelOrderService.findLinkUserIdsListByOrderStatus(userCode);
	}
}
